...
| [.github](https://github.com/orion-trading-platform/.github) | Python | This repo. Contains the dev orchestrator script (`dev.py`) for one-command local setup and a setup guide. |
